...
Version 0.5.2 coordinates protocol 0.1.11 with Android 0.5.2 (build 14), adds ordered image galleries to Question creation, batches and revisions, durable sanitized media, immutable gallery history, and accessible Web/Android viewers, and keeps browser Question context and actions visible while long Questions scroll. Existing Pi sessions require a full restart to load the new protocol and tool schema.
