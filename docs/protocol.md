...
- Package 0.5.5 uses protocol 0.1.12 and Android 0.5.4 (versionCode 16). Ordered Question image galleries and sticky workspace controls are preserved alongside fresh Question Chat and shared model/effort Settings. See [Question image galleries](question-images.md). Restart existing Pi sessions for the combined protocol and tool schema.
