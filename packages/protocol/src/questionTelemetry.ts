...
export const QuestionTelemetryEventSchema = z.object({
  ...
  questionContextLength: z.number().int().nonnegative().optional(),
  relevanceLength: z.number().int().nonnegative().optional(),
  decisionImpactLength: z.number().int().nonnegative().optional(),
